...
class TopSearchBookList extends StatefulWidget {
  List<BookModel>? books;
  TopSearchBookList({this.books});

  @override
  State<TopSearchBookList> createState() => _TopSearchBookListState();
}

class _TopSearchBookListState extends State<TopSearchBookList> {
  ...
  Future<void> getMoreBooks() async {
    MoreBooksModel moreBooks = await ApiCalling.getPopularMoreBooks(page);
    stbs.state.setMorePopularBooks(moreBooks);
    print("object");
  }
  ...
  void initScrollListener() {
    scrollController.addListener(() async {
      if (scrollController.position.maxScrollExtent ==
        ...
        if (stbs.state.morePopularBooks.data!.length <
            stbs.state.morePopularBooks.total) {
          page++;
          getMoreBooks();
        }
      }
        ...
        builder: (context, _) => Scaffold(
              ...
              body: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemCount: stbs.state.morePopularBooks.data!.length,
                  itemBuilder: (context, int index) {
                    return stbs.state.morePopularBooks.data!.isEmpty
                        ? Text("")
                        : Column(
                            children: [
                              InkWell(
                                            ...
                                            child: Padding(
                                                ...
                                                child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "Author: ${stbs.state.morePopularBooks.data![index].name}",
                                                        style: AppStyles
                                                            .getTextStyle(
                                                                14.0,
                                                                FontWeight.w600,
