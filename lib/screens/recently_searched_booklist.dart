...
class RecentlySearchedBookList extends StatefulWidget {
  List<BookModel>? books;
  RecentlySearchedBookList({this.books});

  @override
  State<RecentlySearchedBookList> createState() => _RecentlySearchedBookListState();
}

class _RecentlySearchedBookListState extends State<RecentlySearchedBookList> {
