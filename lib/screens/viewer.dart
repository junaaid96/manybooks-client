...
import 'package:manybooks_v2/utils/helpers.dart';
import 'package:manybooks_v2/widgets/reading_page_bottombar.dart';
import 'package:pdftron_flutter/pdftron_flutter.dart';
import 'package:xml/xml.dart' as xml;
// String? document;
// class DocumentGet{
//   getDocumentId(String doc){
// document = doc;
// }
// }
...
class _ViewerState extends State<Viewer> {
  ...
  // String _document =
  //     "https://drive.google.com/uc?id=10uVZL1CCBT_ttMw6uNGPv0mM8eJtgNbN&export=download";
...
// config.bottomToolbar = [PageScrollIndicator()];
// config.signatureColors=[];
// config.singleLineToolbar=false;
    ...
    try {
      ...
      PdftronFlutter.importAnnotationCommand(
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
              ...
              "    </xfdf>");
      var read_data = PdftronFlutter.importAnnotations(
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
              "    <xfdf xmlns=\"http://ns.adobe.com/xfdf/\" xml:space=\"preserve\">\n" +
              "      <add>\n" +
              "        <square style=\"solid\" width=\"5\" color=\"#E44234\" opacity=\"1\" creationdate=\"D:20200619203211Z\" flags=\"print\" date=\"D:20200619203211Z\" name=\"c684da06-12d2-4ccd-9361-0a1bf2e089e3\" page=\"1\" rect=\"113.312,277.056,235.43,350.173\" title=\"\" />\n" +
              ...
              "      <pdf-info import-version=\"3\" version=\"2\" xmlns=\"http://www.pdftron.com/pdfinfo\" />\n" +
              "    </xfdf>");
      print("annotated data: $read_data");
    ...
    var annotCancel = startExportAnnotationCommandListener((xfdfCommand) {
      ...
      // List<PDFModel> xmlPdf = Helpers.convertXMLJsonToList(command);
      // print("Converted xml:\n $xmlPdf");
      print(command);
      final document = xml.XmlDocument.parse(command);
      // final stringDocument = document.toString();
      final contents = document.findAllElements('contents').first.text;
      print(contents);
    });
