...
import 'package:manybooks_v2/screens/recently_searched_booklist.dart';
import 'package:manybooks_v2/screens/top_search_booklist.dart';
...
class CategoryOfBooks extends StatelessWidget {
  CategoryModel? categoryModel;
  int? index;
  CategoryOfBooks({super.key, this.categoryModel, this.index});
  // const CategoryOfBooks({super.key});
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  if (index == 0)
                    OneContext().push(
                        MaterialPageRoute(builder: (_) => TopSearchBookList()));
                  else
                    OneContext().push(MaterialPageRoute(
                        builder: (_) => RecentlySearchedBookList()));
